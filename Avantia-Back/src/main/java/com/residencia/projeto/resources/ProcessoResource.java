...
import com.residencia.projeto.services.ProcessoService;
...
public class ProcessoResource {
	...
	@GetMapping
	public ResponseEntity<Page<ProcessoDTO>> findAll(
		...
		Page<ProcessoDTO> list = service.findAllPaged(pageRequest);
	...
	@PostMapping
	public ResponseEntity<ProcessoDTO> insert(@RequestBody ProcessoDTO dto){
	...
	public ResponseEntity<ProcessoDTO> delete(@PathVariable long id){
		service.delete(id);
